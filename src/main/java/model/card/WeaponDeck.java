...
public class WeaponDeck extends Deck{
    ...
    private List<Weapon> generationWeapons(){
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations),0);
        description ="with focus shot: Deal 1 additional damage to one of those targets.\n";
        ...
        description ="with turret tripod: Deal 1 additional damage to the other of " +
        ...
        effects.put(new Effect(description,Collections.emptyList(), operations),0);
        description = "with chain reaction: Deal 1 damage to a second target that your first target can see.\n";
        operations = Arrays.asList(new ThorTargets(0), selectTarget1, damage1, setTargetToSelected);
        effects.put(new Effect(description, Collections.singletonList(AmmoColor.BLUE), operations), 1);
        description = "with high voltage: Deal 2 damage to a third target that your second target can see. " +
        ...
        operations = Arrays.asList(visiblePlayers, selectTarget1, damage2, setTargetToSelected);
        effects.put(new Effect(description, Collections.emptyList(), operations),0);
        description = "with phase glide: Move 1 or 2 squares. This effect can be used either before or after the basic effect.\n";
        operations = Collections.singletonList(run2);
        effects.put(new Effect(description ,Collections.emptyList(), operations), -1);
        description = "with charged shot: Deal 1 additional damage to your target.\n";
        ...
        effects = new HashMap<>();
        description = "effect: Deal 3 damage and 1 mark to 1 target you can see. Your target must be at least 2 moves away from you.\n" ;
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "in punisher mode: Choose a target 0, 1, or 2 moves away from you. " +
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations),0);
        description = "with black hole: Choose up to 2 other targets on the vortex or 1 move away from it. " +
        ...
        effects = new HashMap<>();
        description = "basic mode: Deal 1 damage to 1 target you can see at least 1 move away. " +
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "in barbecue mode: Choose 2 squares as above. Deal 2 damage to " +
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "with extra grenade: Deal 1 damage to every player on a square you can see. " +
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "with rocket jump: Move 1 or 2 squares. This effect can be used either before or after the basic effect.\n";
        operations = Collections.singletonList(run2);
        effects.put(new Effect(description, Collections.singletonList(AmmoColor.BLUE), operations), -1);
        description = "with fragmenting warhead: During the basic effect, deal 1 damage to " +
        ...
        effects.put(new Effect(description,Collections.emptyList(), operations), 0);
        description = "in piercing mode: Choose a cardinal direction and 1 or 2 targets in that direction. Deal 2 damage to each.\n";
        ...
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "with shadowstep: Move 1 square before or after the basic effect.\n";
        operations= Collections.singletonList(new Run(1));
        effects.put(new Effect(description, Collections.emptyList(), operations), -1);
        description = "with slice and dice: Deal 2 damage to a different target on your square. " +
        ...
        effects = new HashMap<>();
        description = "basic mode: Choose 1 target on any square exactly 1 move away. Move onto that square " +
                "and give the target 1 damage and 2 marks. in rocket fist mode: Choose a square\n";
        operations = Arrays.asList(maxDistance1, minDistance0, selectTarget1, damage1, mark2, moveToTarget);
        effects.put(new Effect(description, Collections.emptyList(), operations), 0);
        description = "exactly 1 move away. Move onto that square. You may deal 2 damage to 1 target there. " +
        ...
        effects = new HashMap<>();
        description = "basic mode: Choose up to 3 targets on different squares, each exactly 1 move away. " +
        ...
        effects.put(new Effect(description,Collections.emptyList(), operations),0);
        description = "in pulverize mode: Deal 3 damage to 1 target on your square, then move that target 0, 1, " +
